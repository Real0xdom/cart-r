...
exports.subscribeToLocationHistory = subscribeToLocationHistory;
...
TaskManager.defineTask(LOCATION_TASK_NAME, async ({ data, error }) => {
    ...
    if (data) {
        ...
        if (location) {
            await updateDriverLocation(location.coords.latitude, location.coords.longitude, location.coords.heading || undefined, location.coords.speed || undefined);
        }
    }
});
...
function subscribeToLocationHistory(driverId, bookingId, onNewLocation) {
    const subscription = supabase_1.supabase
