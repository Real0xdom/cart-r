...
const TabIcon = ({ source, focused, }) => (<react_native_1.View className={`flex flex-row justify-center items-center rounded-full ${focused ? "bg-gray-700" : ""}`}>
        <react_native_1.View className={`rounded-full w-12 h-12 items-center justify-center ${focused ? "bg-general-500" : ""}`}>
...
const DriverTabsLayout = () => {
    return (<expo_router_1.Tabs initialRouteName="home" screenOptions={{
            ...
            <expo_router_1.Tabs.Screen name="requests" options={{
            title: "Requests",
            headerShown: false,
            tabBarIcon: ({ focused }) => (<TabIcon source={constants_1.icons.list} focused={focused}/>),
        }}/>
            <expo_router_1.Tabs.Screen name="earnings" options={{
            title: "Earnings",
            headerShown: false,
            tabBarIcon: ({ focused }) => (<TabIcon source={constants_1.icons.dollar} focused={focused}/>),
        }}/>
...
exports.default = DriverTabsLayout;
