...
const delivery_truck_png_1 = __importDefault(require("@/assets/images/delivery-truck.png"));
const truck_transparent_png_1 = __importDefault(require("@/assets/images/truck-transparent.png"));
const home_banner_png_1 = __importDefault(require("@/assets/images/home-banner.png"));
const login_hero_jpg_1 = __importDefault(require("@/assets/login-hero.jpg"));
exports.images = {
    ...
    deliveryTruck: delivery_truck_png_1.default,
    truckTransparent: truck_transparent_png_1.default,
    homeBanner: home_banner_png_1.default,
    check: check_png_2.default,
    noResult: no_result_png_1.default,
    message: message_png_1.default,
    loginHero: login_hero_jpg_1.default,
};
exports.icons = {
