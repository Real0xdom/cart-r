...
function Help() {
    return (<react_native_safe_area_context_1.SafeAreaView className="flex-1 bg-white px-5">
      ...
      <react_native_1.View className="flex flex-row items-center py-4">
        ...
        <react_native_1.Text className="text-xl font-JakartaBold">Help Center</react_native_1.Text>
      </react_native_1.View>

      {/* Content */}
      <react_native_1.View className="flex-1 items-center justify-center">
        <react_native_1.Text className="text-base text-gray-500">Contact us at support@cartr.com</react_native_1.Text>
      </react_native_1.View>
