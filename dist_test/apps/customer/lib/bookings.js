...
exports.retryBookingWithIncreasedPrice = retryBookingWithIncreasedPrice;
...
async function createBooking(params) {
    try {
        ...
        const { customerId, vehicle, receiverDetails, goodsDescription, tipAmount = 0, fareMultiplier = 1.0, } = params;
    ...
    try {
      ...
      `)
        ...
        console.log('[GET_CUSTOMER_BOOKINGS] Query result:', {
            ...
            errorCode: (error === null || error === void 0 ? void 0 : error.code) || null,
            errorDetails: (error === null || error === void 0 ? void 0 : error.details) || null
        });
 ...
 */
async function retryBookingWithIncreasedPrice(bookingId, newTipAmount, newFareMultiplier) {
    try {
