...
const FindRide = () => {
    ...
    return (<RideLayout_1.default title="Ride" snapPoints={["85%"]}>
      ...
      <react_native_1.View className="my-3">
        ...
        <GoogleTextInput_1.default icon={constants_1.icons.target} initialLocation={destinationAddress} containerStyle="bg-neutral-100" textInputBackgroundColor="transparent" handlePress={(location) => setDestinationLocation(location)}/>
      </react_native_1.View>

      <CustomButton_1.default title="Find Now" onPress={() => expo_router_1.router.push("/(root)/confirm-ride")}/>
