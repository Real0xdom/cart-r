...
function RootLayout() {
    ...
    return (<AuthContext_1.AuthProvider>
      <expo_router_1.Stack>
        ...
        <expo_router_1.Stack.Screen name="(root)" options={{ headerShown: false }}/>
        <expo_router_1.Stack.Screen name="(customer)" options={{ headerShown: false }}/>
        <expo_router_1.Stack.Screen name="(driver)" options={{ headerShown: false }}/>
        <expo_router_1.Stack.Screen name="(admin)" options={{ headerShown: false }}/>
