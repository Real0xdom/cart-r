        ...
        <SafeAreaView className="flex-1 bg-white">
            ...
            >
                ...
                <View className="mx-5 bg-green-50 border border-green-200 rounded-2xl p-6 mb-6">
                    ...
                    <Text className="text-gray-900 text-4xl font-JakartaBold">Γé╣{totalEarnings.toLocaleString()}</Text>
                    <View className="flex-row mt-4 gap-6">
                        ...
                        <View>
                            ...
                            <Text className="text-gray-900 font-JakartaSemiBold">Γé╣{(driverProfile?.total_earnings || 0).toLocaleString()}</Text>
                        </View>
                        <View>
                            <Text className="text-gray-500 text-xs">{t('avgPerTrip')}</Text>
                            <Text className="text-gray-900 font-JakartaSemiBold">Γé╣{avgPerTrip}</Text>
                        </View>
                    </View>
                </View>
                            ...
                            <View key={trip.id} className="bg-gray-50 border border-gray-200 rounded-xl p-4 mb-3 flex-row justify-between items-center">
                                <View className="flex-1">
                                    <Text className="text-gray-900 font-JakartaSemiBold" numberOfLines={1}>
                                        {trip.origin_address.split(',')[0]} ΓåÆ {trip.destination_address.split(',')[0]}
                                    </Text>
