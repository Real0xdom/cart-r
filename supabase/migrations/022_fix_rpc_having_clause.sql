-- Migration: 022_fix_rpc_having_clause.sql
-- Purpose: Fix GROUP BY error by using a subquery instead of HAVING
...
BEGIN
  ...
  FROM (
    SELECT 
      ...
      b.vehicle_type::VARCHAR AS vehicle_type,
      b.payment_method::VARCHAR AS payment_method,
      b.expires_at,
      b.tip_amount,
      b.fare_multiplier,
      (6371 * acos(
