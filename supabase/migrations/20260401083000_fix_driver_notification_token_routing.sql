-- Ensure ride request pushes use driver-scoped tokens only.
-- This avoids customer app builds/logins overwriting the legacy shared
-- users.expo_push_token fallback for accounts that can access both apps.
