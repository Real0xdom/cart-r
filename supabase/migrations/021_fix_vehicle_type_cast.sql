-- Migration: 021_fix_vehicle_type_cast.sql
-- Purpose: Fix type mismatch in get_available_bookings_v2
-- The bookings.vehicle_type is an ENUM, but parameter was VARCHAR
...
BEGIN
  ...
  SELECT 
    ...
    b.vehicle_type::VARCHAR,  -- Cast ENUM to VARCHAR for return
  ...
  WHERE 
    ...
    AND b.vehicle_type = p_vehicle_type::vehicle_type  -- Cast VARCHAR param to ENUM
    AND NOT EXISTS (
