...
const DriverAccountBlocked = () => {
  ...
  if (driverProfile && driverAppEnabled !== false) {
    return <Redirect href="/" />;
  }

  const onRequestAppeal = async () => {
    const subject = encodeURIComponent("Driver account appeal");
    const body = encodeURIComponent(
      "Hello Cartr Support,%0D%0A%0D%0AI would like to appeal my driver account suspension.%0D%0A%0D%0APhone number:%0D%0AReason:%0D%0A"
    );
  ...
  return (
    <View style={styles.overlay}>
      <View style={styles.card}>
        ...
        <Text style={styles.title}>Driver account locked</Text>
        <Text style={styles.body}>
          You've been banned from the driver app. If you believe this was a mistake, you can request an appeal with Cartr support.
        </Text>
...
export default DriverAccountBlocked;
