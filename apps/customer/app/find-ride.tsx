...
import { Text, View, TouchableOpacity, ActivityIndicator, Animated, ScrollView } from "react-native";
  ...
  return (
    ...
    >
      ...
      <View className="my-3">
        ...
        <Animated.View style={{ transform: [{ translateX: pickupShake }] }}>
          <GoogleTextInput
            icon={icons.target}
      ...
      <View className="my-3">
        ...
        <Animated.View style={{ transform: [{ translateX: dropShake }] }}>
          <GoogleTextInput
            icon={icons.target}
